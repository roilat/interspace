...
alter table T_BLOG_ARTICLE comment '博客文章';
...
alter table T_BLOG_ATTACHMENT comment '博客附件';
...
(
   ...
   LEVEL                smallint comment '类目层级',
   ORDER_NUM            smallint comment '类目排序',
...
alter table T_BLOG_CATEGORY comment '博客类目';
...
alter table T_BLOG_LINK comment '博客链接';
...
(
   ...
   ORDER_NUM            smallint comment '事件排序',
...
alter table T_DDCZ_EVENTS comment '豆豆成长记事表';
...
alter table T_PHOTO_ALBUM_FILE comment '相册文件';
...
(
   ...
   ORDER_NUM            smallint comment '相册排序',
...
alter table T_PHOTO_ALBUM_LIST comment '相册分类';
