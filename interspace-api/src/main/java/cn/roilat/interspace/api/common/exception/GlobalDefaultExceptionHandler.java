...
import cn.roilat.interspace.api.common.result.WebErrorResult;
...
public class GlobalDefaultExceptionHandler {
    ...
    @ResponseBody
    public WebErrorResult interspaceExceptionHandler(LinjiezhijiaException exception, HttpServletResponse response) {
