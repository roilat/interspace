package cn.roilat.linjiezhijia.blog.core.hook.interceptor.desk;

import cn.roilat.linjiezhijia.blog.core.hook.interceptor.InterceptorHookSupport;
...
public class ChannelControllerHook extends InterceptorHookSupport {
    ...
    public String[] getInterceptor() {
        //说明要拦截的controller
        return new String[]{"cn.roilat.linjiezhijia.blog.web.controller.desk.ChannelController"};
    }
