    ...
    var initEditor = function (callback) {
        require.async(['form', 'tinymce'], function () {
            var options = {
                ...
                theme: 'modern',
                language: "zh_CN",
                upload_image_url: _INTERSPACE_BLOG.BASE_PATH + "/post/upload", //配置的上传图片的路由
                height: 400,
                plugins: [
                ...
                // entity_encoding: 'raw',
                content_css: [
                    _INTERSPACE_BLOG.BASE_PATH + '/dist/vendors/bootstrap/css/bootstrap.min.css',
                    _INTERSPACE_BLOG.BASE_PATH + '/dist/css/editor.css',
                ],
