<form id="qForm" class="form-horizontal" method="post" action="update">
    ...
    <div class="scheme" data-scheme="upyun">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="upyun_oss_domain" class="form-control" value="${options['upyun_oss_domain']}" placeholder="示例: http://roilat.b0.upaiyun.com">
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="scheme" data-scheme="qiniu">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">域名绑定</label>
            <div class="col-sm-6">
                <input type="text" name="qiniu_oss_domain" class="form-control" value="${options['qiniu_oss_domain']}" placeholder="示例: http://qiniu.roilat.com">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">文件目录</label>
