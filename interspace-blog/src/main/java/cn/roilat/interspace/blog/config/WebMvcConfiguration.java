package cn.roilat.interspace.blog.config;

import com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter;
import cn.roilat.interspace.blog.web.interceptor.BaseInterceptor;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(baseInterceptor).addPathPatterns("/**").excludePathPatterns("/dist/**", "/store/**",
				"/static/**");
	}
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/theme/*/dist/**").addResourceLocations("classpath:/templates/")
