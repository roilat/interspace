package cn.roilat.interspace.blog.base.oauth;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import cn.roilat.interspace.blog.base.oauth.utils.EnumOauthTypeBean;
import cn.roilat.interspace.blog.base.oauth.utils.OathConfig;
...
//    params.put("redirect_uri", getRedirectUri());
		...
		String token = TokenUtil.getAccessToken(super.doPost(TOKEN_URL, params, headers));
		LOGGER.debug(token);
		return token;
	}
