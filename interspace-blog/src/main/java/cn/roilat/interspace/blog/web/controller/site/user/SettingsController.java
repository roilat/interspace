package cn.roilat.interspace.blog.web.controller.site.user;

import cn.roilat.interspace.blog.base.lang.Result;
import cn.roilat.interspace.blog.base.lang.Consts;
import cn.roilat.interspace.blog.base.utils.FileKit;
...
import cn.roilat.interspace.blog.modules.service.SecurityCodeService;
...
import cn.roilat.interspace.blog.web.controller.site.posts.UploadController;
...
public class SettingsController extends BaseController {
	...
	public String updateProfile(String name, String signature, Integer gender, ModelMap model) {
		Result<?> data;
		AccountProfile profile = getProfile();
	...
	@PostMapping("/avatar")
	@ResponseBody
	public UploadController.UploadResult updateAvatar(
